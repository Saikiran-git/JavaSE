...
import com.kiran.java.mockito.HandsOnLMSRefactoring.Transaction;
...
public class Transaction {
    ...
    public Transaction(Member member, Book book, int transactionId, String transactionType, Date transactionDate, Date bookToBeReturnDate, double penalty, Date bookReturnDate) {
        this.member = member;
        this.book = book;
    ...
    public String toString() {
        ...
        stringJoiner.add("Book Id:" + ((Book) book).getBookId());
